...
const HomePage = () => {
    ...
    const projectGenerationFeatures = [
        {
            ...
            description: 'We start by clearly defining the project goal, which helps to understand the tasks and requirements that must be included in the project creation process.',
        },
        {
            name: 'Selecting AI Model',
            description: 'Based on the defined goal, we choose the appropriate AI model that best fits the project requirements and enables the automation of the project requirements generation process.',
        },
    ];
    ...
    return (
        <div>
            ...
            {/* Dodaj inne sekcje, jak Features, Testimonials, CTA */}
        </div>
    );
};
