...
@ray.remote
def ask_ai_about_project_task(
    question: str, project_id: str, ai_model: AI, get_project_dao_ref, callback: str
):
    try:
        project_dao = get_project_dao_ref()
        project_basic_details = project_dao.get_project_model_and_basic_information(
            project_id
        )
        question_with_project_details = (
            f"Question: {question}. "
