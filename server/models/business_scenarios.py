...
@ray.remote
def generate_business_scenarios(for_who: str, doing_what: str, additional_info: str, project_id: str, model_ai: type[AI]):
    business_scenarios = generate_model(BusinessScenariosModule, for_who, doing_what, additional_info, BusinessScenarios, model_ai)
