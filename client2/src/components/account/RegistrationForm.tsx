...
import { fetchUserRegister } from '@/api/rest/account';
import { useSnackbar } from 'notistack';
import { useNavigate } from 'react-router-dom';
import { InvalidCredentialsError } from '@/utils/exceptions';
...
const RegisterForm = () => {
    ...
    const submitButton = (): void => {
        ...
        fetchUserRegister(nameFieldRef.current?.value, emailFieldRef.current?.value, passwordFieldRef.current?.value)
        .then(() => {
            navigate("/login")
        ...
        .catch(error => {
            if (error instanceof InvalidCredentialsError) {
                enqueueSnackbar(`'Error during registration. Details: ${error.message}'`, { variant: 'error' })
            }
            throw error
        });
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <Input type="string" ref={nameFieldRef} onBlur={() => validateNameField()} />
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <Input type="email" ref={emailFieldRef} onBlur={() => validateEmailField()} />
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <Input type="password" ref={passwordFieldRef} onBlur={() => validatePasswordField()} />
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <Input type="password" ref={confirmPasswordFieldRef} onBlur={() => validateConfirmPasswordField()} />
