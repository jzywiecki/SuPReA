...
import { fetchCreateProject, fetchCreateEmptyProject } from '@/api/rest/project';
...
const NewProject = () => {
    ...
    const [textAiModel, setTextAiModel] = useState<string>('');
    const [imageAiModel, setImageAiModel] = useState<string>('');
    ...
    const createProjectByAi = () => {
        ...
        fetchCreateProject(
            ...
            forWhoFieldRef.current?.value,
            doingWhatFieldRef.current?.value,
            additionalInfoFieldRef.current?.value,
            user?.id,
            textAiModel,
            imageAiModel,
        )
        .then(resultId => {
            ...
            navigation(`/projects/${resultId}/editor`)
        })
        .catch(error => {
