...
interface IntroductionWithPictureProps {
  title: string;
  subtitle: string;
  description: string;
  features: Feature[];
...
const IntroductionWithPicture = ({ title, subtitle, description, features, imageSrc, imageAlt, ref }: IntroductionWithPictureProps) => (
